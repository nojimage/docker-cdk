...
2. バージョン変換（例：CDK 2.1027.0 → タグ 2.22.102700）
3. GitHubリリースを自動作成
...
**変換例:**
- CDK 2.1031.0 → `2.22.103100`
- CDK 2.1031.1 → `2.22.103101`
- CDK 2.1031.12 → `2.22.103112`

### セマンティックバージョニング

- `v2.22.102700` - 特定バージョン（Git タグ）
- `2.22.102700` - 特定バージョン（Docker タグ）
- `2.22` - Minor最新
- `2` - Major最新

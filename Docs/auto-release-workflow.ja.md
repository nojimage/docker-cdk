...
2. バージョン変換（例：CDK 2.1027.0 → タグ 2.24.1027-0）
3. GitHubリリースを自動作成
...
- Prerelease: CDKのPatchバージョン（0）

### セマンティックバージョニング

- `v2.24.1027-0` - 特定バージョン（Git タグ）
- `2.24.1027-0` - 特定バージョン（Docker タグ、パッチ付き）
- `2.24.1027` - 特定バージョン（Docker タグ、パッチなし）
- `2.24` - Minor最新
- `2` - Major最新
